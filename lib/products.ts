...
export const products: Product[] = [
  // Featured / Special - Y2K Rebrand
  {
    ...
    wax: 'Vegan soy blend',
    sizes: [
      { name: 'Bedroom Size', size: '12 oz', price: 30, stock: 1 },
      { name: 'Living Room Size', size: '20 oz', price: 45, stock: 1 },
    ],
  ...
  // Pride Collection
  {
    ...
    wax: 'Vegan soy blend',
    sizes: [
      { name: 'Bedroom Size', size: '12 oz', price: 30, stock: 2 },
      { name: 'Living Room Size', size: '20 oz', price: 45, stock: 2 },
    ],
  },
  {
    id: 'palm-springs',
  ...
  },
  {
    ...
    sizes: [
      { name: 'Bedroom Size', size: '12 oz each', price: 110, stock: 3 },
      { name: 'Living Room Size', size: '20 oz each', price: 170, stock: 3 },
    ],
  },
  {
    id: 'pride-match-set',
  ...
  // Boyfriend Collection
  {
    ...
    sizes: [
      { name: 'Bedroom Size', size: '12 oz', price: 30, stock: 1 },
      { name: 'Living Room Size', size: '20 oz', price: 45, stock: 3 },
    ],
  },
  {
    id: 'bro',
  ...
  },
  {
    ...
    price: 75,
    stock: 12,
    description: 'Try all 3 at a discounted rate! Includes Hipster, Bro, and Ivy Leaguer.',
    scentNotes: ['Variety Pack'],
    ...
    sizes: [
      { name: 'Bedroom Size', size: '12 oz each', price: 75, stock: 6 },
      { name: 'Living Room Size', size: '20 oz each', price: 120, stock: 6 },
    ],
  },
  ...
  },
  {
    ...
    wax: 'Vegan soy blend',
    sizes: [
      { name: 'Bedroom Size', size: '12 oz', price: 25, stock: 999 },
      { name: 'Living Room Size', size: '20 oz', price: 40, stock: 999 },
    ],
  },
];
